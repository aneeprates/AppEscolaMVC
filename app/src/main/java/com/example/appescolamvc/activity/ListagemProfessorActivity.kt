...
import com.example.appescolamvc.adapter.AlunoAdapter
import com.example.appescolamvc.adapter.ProfessorAdapter
import com.example.appescolamvc.api.RetrofitHelper
import com.example.appescolamvc.databinding.ActivityListagemProfessorBinding
...
class ListagemProfessorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnCadProf.setOnClickListener {
        ...
        call.enqueue(object : Callback<Void> {
            override fun onResponse(call: Call<Void>, response: Response<Void>) {
                if (response.isSuccessful) {
                    ...
                    loadProfessor() // Atualizar a lista de professor após exclusão
                } else {
                    Toast.makeText(
                        this@ListagemProfessorActivity,
